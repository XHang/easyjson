# easyjson [![Build Status](https://travis-ci.org/mailru/easyjson.svg?branch=master)](https://travis-ci.org/mailru/easyjson) [![Go Report Card](https://goreportcard.com/badge/github.com/amoeba-inc/easyjson)](https://goreportcard.com/report/github.com/amoeba-inc/easyjson)
...
```sh
# install
go get -u github.com/amoeba-inc/easyjson/...
...
listing](https://godoc.org/github.com/amoeba-inc/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/amoeba-inc/easyjson/buffer)
